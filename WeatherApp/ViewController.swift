...
//  WeatherApp
//
//  Created by Bryce Sulin on 5/13/17.
...
class ViewController: UIViewController, UISearchBarDelegate {
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        let urlRequest = URLRequest(url: URL(string: "http://api.apixu.com/v1/current.json?key=fd0f7e9c55ce45f19f1173728171305&q=\(searchBar.text!.replacingOccurrences(of: " ", with: "%20"))")!)
